            ...
            <StyledMainContainer>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <IconButton
                            onClick={() => copyText(longUrl, 0, setToggleIcon)}
                        >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <IconButton
                            onClick={() => copyText(shortUrl, 1, setToggleIcon)}
                        >
                ...
                >
                    ...
                    >
                        <IconButton
                            onClick={() =>
                                copyCanvasToClipboard(canvasRef, setToggleIcon)
                            }
                        >
                            {(!toggleIcon[2] && <CopyIcon />) || <DoneIcon />}
                        </IconButton>
                        <IconButton
                            onClick={() => onCanvasButtonClick(canvasRef)}
                        >
                            <Download />
                        </IconButton>
                    </div>
