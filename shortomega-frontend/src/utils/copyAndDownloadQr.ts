...
export function onCanvasButtonClick(canvasRef: React.RefObject<HTMLCanvasElement>) {
...
export async function copyCanvasToClipboard(canvasRef: React.RefObject<HTMLCanvasElement>, setToggleIcon: React.Dispatch<React.SetStateAction<boolean[]>>) {
...
export const copyText = (value: string, idx: number, setToggleIcon: React.Dispatch<React.SetStateAction<boolean[]>>) => {
